...
public interface CursorCommand {
    ...
    /**
     * When we move the cursor to a new line we want to move
     * it to the last charater of the new line if the current line
     * is longer, otherwise we want to leave it on the same column.
     * @param panel The panel where the text area is.
     * @param newLine The index of the new line we want to move to.
     * @return returns the offset(positive or negative) we have to move
     * our cursor when going to a new line.
     */
